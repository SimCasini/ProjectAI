...
def test_plot(file, attrnames, target, values):
    ...
    for pp in p:
        ...
        accV_media = 0
        for j in range(10):
            accT, accV = ten_fold_cross_validation(dataset, pp)
            accT_media += accT
            accV_media += accV
...
def ten_fold_cross_validation(dataset, prob):
    ...
    for fold in range(10):
        ...
        tree = decision_tree_alg(dataset_1)
